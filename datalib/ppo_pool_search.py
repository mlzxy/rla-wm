...
import optuna
import tyro
from datalib.ppo import Args

VALID_CONFIGS = [
    # ("PushT-v2", "panda_stick"),  # TESTING
    ("PokeCube-v2", "xarm6_robotiq"), # 0
    ("PullCube-v2", "xarm6_robotiq"), # 1
    # ("StackCube-v1", "xarm6_robotiq"),
    ("PullCubeTool-v1", "xarm6_robotiq"), # 2
    ("PushT-v2", "xarm6_robotiq_closed"), # 3
    ("RollBall-v1", "xarm6_robotiq_closed"), # 4
    ("PegInsertionSide-v1", "xarm6_robotiq"), # 5
    # ("PokeCube-v2", "ur10e_stick"),
    ("PullCube-v2", "panda"), # 6
    ("PullCube-v2", "ur10e_stick"), # 7
    # Non-stick tasks
    # ("StackCube-v1", "panda"),
    ("RollBall-v1", "panda_closed"), # 8
    ("PegInsertionSide-v1", "panda"), # 9
    ("RollBall-v1", "ur10e_stick"), # 10
    ("PushT-v2", "panda_closed"), # 11
    ("PushT-v2", "ur10e_stick"), # 12
    ("PokeCube-v2", "panda"), # 13
    ("PullCubeTool-v1", "panda"), # 14
]  # 0-14
...
def objective(trial, config_idx, pool, base_args, pool_args: "SearchArgs"):
    ...
    args.base_run_dir = "runs/SearchRuns"
...
def main():
    ...
    pool_root = f"runs/Pool/{args.config_idx}_{task}_{robot}"

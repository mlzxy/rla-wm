...
class FlowMatchingTrainer(BasicTrainer):
    ...
    def get_v(
        ...
        Math:
            x_t = (1 - t) * x_0 + (σ_min + (1 - σ_min) * t) * x_1
            v_t = d(x_t) / dt = -x_0 + (1 - σ_min) * x_1

        Where x_1 is the noise.
        """
    ...
    def sample_t(self, batch_size: int) -> Float[torch.Tensor, "batch"]:
        """
        Sample timesteps.
        ...
        Returns:
            t: The [batch_size] tensor of diffusion steps [0-1].
        """
    ...
    def training_losses(
        self, x_0: torch.Tensor, cond=None, **kwargs
    ) -> Tuple[Dict, Dict]:
        """
...
class TextConditionedFlowMatchingCFGTrainer(
    TextConditionedMixin, FlowMatchingCFGTrainer
):
    """
...
class ImageConditionedFlowMatchingCFGTrainer(

...
__attributes = {
    ...
    "SparseFeat2RenderCWM": "sparse_feat2render_cwm",
    ...
    "TrajectoryDataset": "trajectory_dataset",
    "SimpleTransitionDataset": "data_worker.base",
}
...
if __name__ == "__main__":
    ...
    from .trajectory_data_worker import TransitionDataset
